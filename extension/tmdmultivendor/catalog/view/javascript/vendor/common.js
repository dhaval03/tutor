...
$(document).on('click', '[data-oc-toggle=\'image\']', function (e) {
    ...
    $.ajax({
        url: 'index.php?route=extension/tmdmultivendor/vendor/filemanager'+ '&target=' + encodeURIComponent($(element).attr('data-oc-target')) + '&thumb=' + encodeURIComponent($(element).attr('data-oc-thumb')),
        dataType: 'html',
        beforeSend: function () {
            $(element).prop('disabled', true).addClass('loading');
        },
