...
class AttributeGroup extends \Opencart\System\Engine\Model {
	public function addAttributeGroup($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "vendor_to_attribute_group SET attribute_group_id = '" . (int)$attribute_group_id . "', vendor_id = '" . (int)$this->vendor->getId() . "'");
	...
	public function getAttributeGroups($data = array()) {
		...
		if(isset($data['vendor_id'])){
			$sql .= " and v2ag.vendor_id='".(int)$data['vendor_id']."'";
		}
