...
public function index(): void {		
		...
		$data['restore'] = $this->url->link('extension/tmdmultivendor/vendor/export|export', 'user_token=' . $this->session->data['user_token']);
		
		$data['export'] = $this->url->link('extension/tmdmultivendor/vendor/export|export', 'user_token=' . $this->session->data['user_token']);
		$data['export1'] = $this->url->link('extension/tmdmultivendor/vendor/export|export1', 'user_token=' . $this->session->data['user_token']);
	...
	public function export() {
		...
		foreach($data as $product) {
			$xml .= "\t<PRODUCT>\n"; 
				...
				$xml .= "\t\t<RelatedProduct>". 			$product['related'] 			."</RelatedProduct>\n";
				$xml .= "\t\t<OptionName>". 					$product['option'] 				."</OptionName>\n";
				$xml .= "\t\t<OptionValue>".					$product['option_val'] 		."</OptionValue>\n";
				...
				$xml .= "\t\t<VendorId>". 				$product['vendor_id'] 				."</VendorId>\n";
				$xml .= "\t\t<Vendor>". 				$product['vendor'] 				."</Vendor>\n";
