...
$_['entry_import']      = 'Import xls File <span class="help">Please Import Same format if you have not format please download <a href="'.HTTP_SERVER.'image/catalog/xls/csv template.xls">From here</a> </span>';
