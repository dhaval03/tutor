...
class Option extends \Opencart\System\Engine\Model {
	public function addOption($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "vendor_to_option SET option_id = '" . (int)$option_id . "', vendor_id = '" . (int)$this->vendor->getId() . "'");
	...
	public function getOptions($data = array()) {
		...
		if(isset($data['vendor_id'])){
			$sql .= " and v2o.vendor_id='".(int)$data['vendor_id']."'";
		}
