<?php
// Heading
$_['heading_title']    = 'TMD Import Excel';
$_['entry_vendors']    = 'Vendors';
$_['button_import']    = 'Import file  ';
$_['entry_import']    = 'Import xls File <span class="help">Please Import Same format if you have not format please download <a href="'.HTTP_CATALOG.'image/catalog/xls/csv template.xls">From here</a> </span>';
