<?php
namespace Opencart\Catalog\Controller\Extension\Tmdmultivendor\Common;
class ColumnInpro extends \Opencart\System\Engine\Controller {
	public function index(): string {
		...
		$modules = $this->model_design_layout->getModules($layout_id, 'column_inpro');
		...
		return $this->load->view('extension/tmdmultivendor/common/column_inpro', $data);
	}
}
