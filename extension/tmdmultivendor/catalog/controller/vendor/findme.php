...
class findme extends \Opencart\System\Engine\Controller {
	// private $error = array();
	public function index() {
		
		$this->load->language('extension/tmdmultivendor/vendor/findme');
		...
		$this->response->setOutput($this->load->view('extension/tmdmultivendor/vendor/findme', $data));
		} else {
