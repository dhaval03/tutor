...
class Enquiry extends \Opencart\System\Engine\Model {
	...
	/// Seller And Customer To Mail ///
		...
		if(isset($this->request->get['product_id'])) {
			/* 10 02 2020 */
			$product_info = $this->model_extension_tmdmultivendor_vendor_product->getProduct($this->request->get['product_id'], $data['vendor_id']);
			/* 10 02 2020 */
		}
		...
		if(isset($vendor_info['vendor_id'])) {
			$seller_info = $this->model_extension_tmdmultivendor_vendor_vendor->getVendor($vendor_info['vendor_id']);
		} else {
			$seller_info = $this->model_extension_tmdmultivendor_vendor_vendor->getVendor($data['vendor_id']);
		}
